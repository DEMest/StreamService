...
const MODES: { key: ViewMode; label: string; num?: number }[] = [
  { key: 'multicam', label: 'Мультикам' },
  { key: 'cam1', label: 'Камера 1', num: 1 },
  { key: 'cam2', label: 'Камера 2', num: 2 },
  { key: 'cam3', label: 'Камера 3', num: 3 },
  { key: 'cam4', label: 'Камера 4', num: 4 },
];
