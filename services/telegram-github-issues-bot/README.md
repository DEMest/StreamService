...
3. Для команды `/issue` режим приватности бота можно оставить включённым:
   Telegram всё равно доставляет команды. Если позже потребуется анализировать
   обычные сообщения группы, отключите Privacy Mode в BotFather.
...
- кнопки «Создать issue» и «Отмена» доступны только тому, кто запросил
  черновик.
